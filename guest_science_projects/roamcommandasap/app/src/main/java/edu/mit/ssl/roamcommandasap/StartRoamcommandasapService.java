...
public class StartRoamcommandasapService extends StartGuestScienceService {
    ...
    public void onGuestScienceCustomCmd(String command) {
        ...
        try {
            ...
            //StopTest
            if(sCommand.equals("StopTest")){
                roam_node.sendCommand(-1);
            }

            //UnitTests
            else if(sCommand.equals("Test1")){
                roam_node.sendCommand(1);
            }
            else if(sCommand.equals("Test2")){
                roam_node.sendCommand(2);
            }
            else if(sCommand.equals("Test3")){
                roam_node.sendCommand(3);
            }
            else if(sCommand.equals("Test4")){
                roam_node.sendCommand(4);
            }
            else if(sCommand.equals("Test5")){
                roam_node.sendCommand(5);
            }
            else if(sCommand.equals("Test6")){
                roam_node.sendCommand(6);
            }
            else if(sCommand.equals("Test7")){
                roam_node.sendCommand(7);
            }
            else if(sCommand.equals("Test8")){
                roam_node.sendCommand(8);
            }
            else if(sCommand.equals("Test9")){
                roam_node.sendCommand(9);
            }
            else if(sCommand.equals("Test10")){
                roam_node.sendCommand(10);
            }
            else if(sCommand.equals("Test11")){
                roam_node.sendCommand(11);
            }
            else if(sCommand.equals("Test12")){
                roam_node.sendCommand(12);
            }

            //StandardTests
            else if(sCommand.equals("Test111")){
                roam_node.sendCommand(111);
            }
            else if(sCommand.equals("Test112")){
                roam_node.sendCommand(112);
            }
            else if(sCommand.equals("Test113")){
                roam_node.sendCommand(113);
            }
            else if(sCommand.equals("Test121")){
                roam_node.sendCommand(121);
            }
            else if(sCommand.equals("Test122")){
                roam_node.sendCommand(122);
            }
            else if(sCommand.equals("Test123")){
                roam_node.sendCommand(123);
            }
            else if(sCommand.equals("Test131")){
                roam_node.sendCommand(131);
            }
            else if(sCommand.equals("Test132")){
                roam_node.sendCommand(132);
            }
            else if(sCommand.equals("Test133")){
                roam_node.sendCommand(133);
            }
            else if(sCommand.equals("Test141")){
                roam_node.sendCommand(141);
            }
            else if(sCommand.equals("Test142")){
                roam_node.sendCommand(142);
            }
            else if(sCommand.equals("Test143")){
                roam_node.sendCommand(143);
            }

            else if(sCommand.equals("211")){
                roam_node.sendCommand(211);
            }
            else if(sCommand.equals("212")){
                roam_node.sendCommand(212);
            }
            else if(sCommand.equals("213")){
                roam_node.sendCommand(213);
            }
            else if(sCommand.equals("221")){
                roam_node.sendCommand(221);
            }
            else if(sCommand.equals("222")){
                roam_node.sendCommand(222);
            }
            else if(sCommand.equals("223")){
                roam_node.sendCommand(223);
            }
            else if(sCommand.equals("231")){
                roam_node.sendCommand(231);
            }
            else if(sCommand.equals("232")){
                roam_node.sendCommand(232);
            }
            else if(sCommand.equals("233")){
                roam_node.sendCommand(233);
            }
            else if(sCommand.equals("241")){
                roam_node.sendCommand(241);
            }
            else if(sCommand.equals("242")){
                roam_node.sendCommand(242);
            }
            else if(sCommand.equals("243")){
                roam_node.sendCommand(243);
            }

            else if(sCommand.equals("311")){
                roam_node.sendCommand(311);
            }
            else if(sCommand.equals("312")){
                roam_node.sendCommand(312);
            }
            else if(sCommand.equals("313")){
                roam_node.sendCommand(313);
            }
            else if(sCommand.equals("321")){
                roam_node.sendCommand(321);
            }
            else if(sCommand.equals("322")){
                roam_node.sendCommand(322);
            }
            else if(sCommand.equals("323")){
                roam_node.sendCommand(323);
            }
            else if(sCommand.equals("331")){
                roam_node.sendCommand(331);
            }
            else if(sCommand.equals("332")){
                roam_node.sendCommand(332);
            }
            else if(sCommand.equals("333")){
                roam_node.sendCommand(333);
            }
            else if(sCommand.equals("341")){
                roam_node.sendCommand(341);
            }
            else if(sCommand.equals("342")){
                roam_node.sendCommand(342);
            }
            else if(sCommand.equals("343")){
                roam_node.sendCommand(343);
            }

            //Role and Scenario Setting
            else if(sCommand.equals("SetRoleChaser")){
                roam_node.setRole("chaser");
            }
            else if(sCommand.equals("SetRoleTarget")){
                roam_node.setRole("target");
            }
            else if(sCommand.equals("SetRoleFromHardware")){
                roam_node.setRole("robot_name");
            }
            else if(sCommand.equals("SetGround")){
                roam_node.setGround();
            }
            else if(sCommand.equals("SetISS")){
                roam_node.setISS();
            }
            else if(sCommand.equals("EnableRoamBagger")){
                roam_node.setRoamBagger("enabled");
            }
            else if(sCommand.equals("DisableRoamBagger")){
